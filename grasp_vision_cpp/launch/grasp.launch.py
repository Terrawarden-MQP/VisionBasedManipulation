...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('header_frame', default_value='camera_depth_optical_frame', description='Frame of reference for the camera point cloud'),
        DeclareLaunchArgument('header_frame_drone', default_value='camera_link', description='Frame of reference for the drone'),
